...
export default function ProductionRow({
  ...
  const processed = processedDays(project, today);
    ...
    >
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-1 flex items-center gap-4 text-xs text-gray-500">
          ...
          <span>分发人：{project.dispatcher}</span>
          <span>校对：{project.proofreader}</span>
          <span>发布：{project.publishedAt}</span>
          <span>进生产线：{project.enteredProductionAt}</span>
